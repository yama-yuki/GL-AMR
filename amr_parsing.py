...
from parser import best_actions, best_labels#

from GL_detect import detection, make_sent_list#
import os
...
def main():
    ...
    # test deterministic oracle 
        ...
        #print >> experiment_log, test_instances
        depfile = amr_file+'.tok.charniak.parse.dep'
        SL = make_sent_list(amr_file)
        #print(depfile)
        GO = detection(depfile)
        #print(GO)

        with open('pickle_SL','wb') as pSL:
            pickle.dump(SL, pSL)
        with open('pickle_GO','wb') as pGO:
            pickle.dump(GO, pGO)
        ...
        #print >> experiment_log , best_actions#
        #print >> experiment_log , best_labels#
        #print(GO)
        #print(SL)
        os.remove('pickle_SL')
        os.remove('pickle_GO')
